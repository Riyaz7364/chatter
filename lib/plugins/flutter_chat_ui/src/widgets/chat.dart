...
import 'message/user_avatar.dart';
...
class Chat extends StatefulWidget {
  ...
  final void Function(BuildContext context, types.Message, Function)?
      onMessageLongPress;
...
class ChatState extends State<Chat> {
  ...
  void didUpdateWidget(covariant Chat oldWidget) {
    ...
    // print(widget.user.blockID.contains(widget.messages.single));
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: HexColor('#${message.metadata!['color']}'),
                ),
                child: Container(
  ...
  Widget _avatarBuilder(dynamic message) =>
      widget.avatarBuilder?.call(message.author.id) ??
      UserAvatar(
